...
import com.cn.android.zhengxun.app.adapter.HomeVisitListAdapter;
...
public class HomeVisitListActivity extends Activity{
	...
	private HomeVisitListAdapter adapter;
	private List<HomeVisitModel> list;
	...
	private OnClickListener clicklistener = new OnClickListener() {
		...
		public void onClick(View v) {
			switch (v.getId()) {
			case R.id.back:
				HomeVisitListActivity.this.finish();
				break;
			case R.id.tv_from_date:
				new DatePickerDialog(HomeVisitListActivity.this,
	...
	private void initData() {
		adapter = new HomeVisitListAdapter(this);
		visitService = new FamilyVisitServiceImpl(this);
		start=cal.getTime();
	...
	private void selecttData() {
		list = visitService.getVisits(start, end);
	...
	private void initViews() {
		...
		txt_title.setText(R.string.visit_history);
